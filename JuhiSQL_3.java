...
public static void main(final String[] args) throws SQLException, IOException, ClassNotFoundException{
 ...
 final Connection con =DriverManager.getConnection("jdbc:mysql://localhost:3306/student","root","welcome");
 ...
 * to update records 
 */
public static void update(final Scanner scan,final Statement sta,final int idoo) throws SQLException
{
